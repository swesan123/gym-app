...
import { saveBodyWeight } from "@/app/actions/profile";
import { MissingSupabaseConfig } from "@/components/MissingSupabaseConfig";
import { Button } from "@/components/ui/button";
import { hasSupabaseEnv } from "@/lib/env";
import { fetchBodyWeight } from "@/lib/queries/read";
...
export default async function ProfileSettingsPage() {
  ...
  const bodyWeight = await fetchBodyWeight();
  ...
  return (
    <div className="mx-auto max-w-lg px-4 pb-28 pt-[max(1rem,env(safe-area-inset-top))]">
      ...
      <form action={saveBodyWeight} className="mt-6 space-y-4">
